...
//                    sh "ssh -i /home/serg/.ssh/id_rsa ${REMOTE_USERNAME}@${REMOTE_SERVER} 'chmod +x ${REMOTE_DESTINATION}/${ABSOLUTE_PATH_TO_DEPLOY_SH}'"
                    ...
                    sh "ssh -o StrictHostKeyChecking=no -o UserKnownHostsFile=/home/serg/.ssh/known_hosts -i /home/serg/.ssh/id_rsa serg@192.168.88.77 'chmod +x /home/serg/miracle-image-server/deploy.sh'"
